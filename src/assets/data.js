...
export const showData = {
  ...
  videoIframeSrc: 'https://www.youtube.com/embed/_GvtV2bfc7Q',
  descriptionParagraphs: [
    ...
    'Пьеса была успешно Представлена в России в формате читки в 2016 году в рамках лаборатории LARK+Любимовка на сцене Центра им. Мейерхольда.',
  ],
  photoGallery: {
  ...
  article: {
    linksTitle: 'Почитать пьесу',
    titleMinWidth: 'Конкретные разговоры пожилых супругов ни о чём',
    author: 'Андрей Иванов',
    authorMinWidth: 'Екатерина Августеняк',
